...
[![Platform](https://img.shields.io/badge/Platform-x86__64%20Linux-blue.svg?style=flat-square)](#installation)
[![Language](https://img.shields.io/badge/Language-100%25%20Rust-red.svg?style=flat-square)](https://www.rust-lang.org/)
[![Adblock](https://img.shields.io/badge/Shield-Brave%20adblock--rust-green.svg?style=flat-square)](#1-caram-shield-core--privacy-subsystem)
[![Engine](https://img.shields.io/badge/Render%20Engine-WebKitGTK%204.1-purple.svg?style=flat-square)](#2-rendering-architecture-tauri-v2-native-multi-webview)
...
Caram Browser is an experimental, independent browser engineered to free Linux workstations from the severe memory footprint, commercial telemetry, and crypto/ad bloatware inherent to modern Chromium forks. 
...
#### 1. Caram Shield Core & Privacy Subsystem
...
#### 3. High-Speed Multi-Threaded Downloader (IDM-Style)
...
#### 4. Caram Vault (Argon2id + AES-256-GCM) & 1-Click Autofill
...
### Empirical Resource & Architecture Benchmarks
...
### Web Compatibility Scope & Known Limitations

1. **Enterprise Google/Chromium WebApps (Google Meet, MS Teams, Discord Web)**:
   WebKitGTK strictly implements W3C web standards. However, platforms like Google Meet rely on Chromium-proprietary WebCodecs, WebRTC internal filters, and client-sniffing. While basic web surfing is pristine, **Google Meet audio/video rooms or screen sharing may glitch or fail**.
...
### Security Advisory & MVP Disclaimer
...
### Các Hệ Thống Kỹ Thuật Trọng Tâm

#### 1. Nhân bảo vệ Caram Shield (300.000+ Quy tắc)
...
#### 2. Lọc sạch Link (Clean URLs & De-AMP)
...
#### 3. Trình Tải File Đa Luồng Siêu Tốc (IDM-Style)
...
#### 4. Két Mật Khẩu Caram Vault & Điền Tự Động (Autofill)
...
### Bảng So Sánh Kỹ Thuật Thực Nghiệm
...
### Giới Hạn Tương Thích & Phạm Vi Hoạt Động
...
### Hướng Dẫn Cài Đặt (Linux x86_64)
...
#### 2. Mọi bản phân phối Linux (`.AppImage`)
...
### Cảnh Báo Bảo Mật & Miễn Trừ Trách Nhiệm (MVP)
